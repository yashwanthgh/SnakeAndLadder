...
namespace SnakeAndLadder
{
    public class Game
    {
        ...
        public void play(string playerNameOne, string playerNameTwo)
        {
            while (true)
            {
                ...
                if (playerNumber == 0)
                {
                    ...
                    {
                        Console.WriteLine($"{playerNameOne} wins with {playerOneDiceRolls} rolls");
                        return;
                    }
                    ...
                    Console.WriteLine($"{playerNameOne}: {playerOne}");
                    playerNumber++;
                    playerOneDiceRolls++;
                    Thread.Sleep(500);
                }
                else
                {
                    ...
                    {
                        Console.WriteLine($"{playerNameTwo} wins with {playerTwoDiceRolls} rolls");
                        return;
                    }
                    else if (newPosition < finalScore)
                    {
                    ...
                    Console.WriteLine($"{playerNameTwo}" +
                        $"" +
                        $"" +
                        $"" +
                        $"" +
